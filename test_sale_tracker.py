...
class TestIntegration(unittest.TestCase):
    ...
    def test_lululemon_live_scraping(self):
        ...
        try:
            name, price, image = main_improved.scrape_lululemon(config.PRODUCT_LINKS["lululemon"][0])
    ...
    def test_nike_live_scraping(self):
        ...
        try:
            name, price, image = main_improved.scrape_nike(config.PRODUCT_LINKS["nike"][0])
