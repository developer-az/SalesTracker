...
def find_lululemon_products():
    ...
    categories = ["mens-jackets-and-outerwear", "mens-leggings", "mens-shorts", "mens-tops", "mens-pants"]
...
def find_nike_products():
    ...
    categories = ["mens-shoes", "mens-clothing", "mens-accessories"]
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        print("\nExample:")
        print(
            "  python3 find_products.py test https://shop.lululemon.com/p/mens-jackets-and-outerwear/Down-For-It-All-Hoodie/_/prod9200786"
        )
